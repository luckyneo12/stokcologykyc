            ...
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "20px" }}>
              <div ref={containerRef} onMouseMove={handlePointerMove} onTouchMove={handlePointerMove} style={{ position: "relative", display: "inline-block", maxWidth: "100%", background: "#1a1a1a", borderRadius: "12px", overflow: "hidden", touchAction: "none", userSelect: "none", lineHeight: 0 }}>
                <div onMouseDown={(e) => handlePointerDown('move', e)} onTouchStart={(e) => handlePointerDown('move', e)} style={{ position: "absolute", top: `${cropRect.top}%`, left: `${cropRect.left}%`, width: `${cropRect.right - cropRect.left}%`, height: `${cropRect.bottom - cropRect.top}%`, border: "2px solid var(--wise-green)", boxShadow: "0 0 0 1000px rgba(0,0,0,0.75)", zIndex: 2, cursor: dragInfo.isDragging && dragInfo.mode === 'move' ? "grabbing" : "grab" }}>
                  <div onMouseDown={(e) => handlePointerDown('nw', e)} onTouchStart={(e) => handlePointerDown('nw', e)} style={{ position: "absolute", top: -18, left: -18, width: 36, height: 36, background: "var(--wise-green)", borderRadius: "50%", cursor: "nwse-resize", zIndex: 10, border: "2px solid white", boxShadow: "0 2px 4px rgba(0,0,0,0.3)" }} />
                  <div onMouseDown={(e) => handlePointerDown('ne', e)} onTouchStart={(e) => handlePointerDown('ne', e)} style={{ position: "absolute", top: -18, right: -18, width: 36, height: 36, background: "var(--wise-green)", borderRadius: "50%", cursor: "nesw-resize", zIndex: 10, border: "2px solid white", boxShadow: "0 2px 4px rgba(0,0,0,0.3)" }} />
                  <div onMouseDown={(e) => handlePointerDown('sw', e)} onTouchStart={(e) => handlePointerDown('sw', e)} style={{ position: "absolute", bottom: -18, left: -18, width: 36, height: 36, background: "var(--wise-green)", borderRadius: "50%", cursor: "nesw-resize", zIndex: 10, border: "2px solid white", boxShadow: "0 2px 4px rgba(0,0,0,0.3)" }} />
                  <div onMouseDown={(e) => handlePointerDown('se', e)} onTouchStart={(e) => handlePointerDown('se', e)} style={{ position: "absolute", bottom: -18, right: -18, width: 36, height: 36, background: "var(--wise-green)", borderRadius: "50%", cursor: "nwse-resize", zIndex: 10, border: "2px solid white", boxShadow: "0 2px 4px rgba(0,0,0,0.3)" }} />
                </div>
