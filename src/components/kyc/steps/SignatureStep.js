            ...
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "24px" }}>
              ...
              >
                <div 
                  ...
                  <div onMouseDown={(e) => handlePointerDown('nw', e)} onTouchStart={(e) => handlePointerDown('nw', e)} style={{ position: "absolute", top: -10, left: -10, width: 20, height: 20, background: "var(--wise-green)", borderRadius: "50%", cursor: "nwse-resize", zIndex: 10, border: "3px solid white" }} />
                  <div onMouseDown={(e) => handlePointerDown('ne', e)} onTouchStart={(e) => handlePointerDown('ne', e)} style={{ position: "absolute", top: -10, right: -10, width: 20, height: 20, background: "var(--wise-green)", borderRadius: "50%", cursor: "nesw-resize", zIndex: 10, border: "3px solid white" }} />
                  <div onMouseDown={(e) => handlePointerDown('sw', e)} onTouchStart={(e) => handlePointerDown('sw', e)} style={{ position: "absolute", bottom: -10, left: -10, width: 20, height: 20, background: "var(--wise-green)", borderRadius: "50%", cursor: "nesw-resize", zIndex: 10, border: "3px solid white" }} />
                  <div onMouseDown={(e) => handlePointerDown('se', e)} onTouchStart={(e) => handlePointerDown('se', e)} style={{ position: "absolute", bottom: -10, right: -10, width: 20, height: 20, background: "var(--wise-green)", borderRadius: "50%", cursor: "nwse-resize", zIndex: 10, border: "3px solid white" }} />
                </div>
