...
const BASE_VARIABLES = [
  ...
  { name: 'DP ID', key: 'dpId', type: 'text', group: 'Personal' },
  { name: 'Client ID', key: 'clientId', type: 'text', group: 'Personal' },
  ...
  { name: 'PEP Comment', key: 'pepComment', type: 'text', group: 'Regulatory' },
  ...
  { name: 'Accept Pledge Inst. (Text)', key: 'acceptPledgeInstructions', type: 'text', group: 'Declarations' },
  { name: 'Accept Pledge Inst. (Yes Check)', key: 'isAcceptPledgeYes', type: 'checkbox', group: 'Declarations' },
  { name: 'Accept Pledge Inst. (No Check)', key: 'isAcceptPledgeNo', type: 'checkbox', group: 'Declarations' },
